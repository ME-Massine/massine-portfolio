...
const links = [
  ...
  {
    label: "◈ LinkedIn",
    href: "https://www.linkedin.com/in/massine-amakhtari-48b815261/",
  },
];
  ...
  return (
    <section id="contact" className="contact-section">
      <div className="contact-inner">
        <div className="contact-label reveal" ref={labelRef}>
          {"// Let's connect"}
        </div>
        ...
        <p className="contact-sub reveal" ref={subRef}>
          I'm actively looking for backend engineering roles focused on
          distributed systems and cloud-native architecture. Let's build
